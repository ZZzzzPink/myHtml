...
let daysDistance = () => {
  ...
  if (ms > dayTime) {
    ...
    console.log(`%c我是开发者Pink 联系我wx:Sweet_tank\n网站已运行${days}天`, 'font-size:12px;color:orange;line-height: 25px;',)
  } else {
    let Rday = Math.floor(ms / dayTime2)
    console.log(`%c我是开发者Pink 联系我wx:Sweet_tank \n网站已运行${Rday}个小时`, 'font-size:12px;color:orange;line-height: 25px;',)
  }
};
